...
desabling, a write to external SDRAM is possible.

First, an erase is done byte by byte to all SDRAM. Then a write is performed. To
check the operation is well done, a read operation is performed. Then a comparaison
...
If the result of comparaison is correct, LED3 is on and the following message is

/**
  @page LTDC_Display_2Layes  LTDC Display 2 Layers example

  @verbatim
  ******************** (C) COPYRIGHT 2013 STMicroelectronics *******************
  * @file    LTDC_Display_2Layes/readme.txt 
  * @version V1.0.0
...
@par Example Description 
 ...
 After LCD initialization, LCD layer 1 is confugured to display an image(ST_logo1)
 and LCD layer 2 is confugured to display another image(ST_logo2) on LCD.
